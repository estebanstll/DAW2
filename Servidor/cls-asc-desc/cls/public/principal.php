	...
	<table style="width: 90%; margin: 20px auto; border-collapse: collapse;">
		...
		<tr>
			...
			<td style="padding: 10px; border: 1px solid #ccc; text-align: center;">
				...
				<!-- Botón VER -->
				<a href="ver.php?id=1" style="background-color: #17a2b8; color: white; padding: 6px 12px; 
						  border-radius: 4px; text-decoration: none; margin-right: 5px;">
					Ver
				</a>

				<!-- Botón EDITAR -->
				<a href="editar.php?id=1" style="background-color: #28a745; color: white; padding: 6px 12px;
						  border-radius: 4px; text-decoration: none; margin-right: 5px;">
					Editar
				</a>

				<!-- Botón BORRAR -->
				<a href="borrar.php?id=1" style="background-color: #dc3545; color: white; padding: 6px 12px;
