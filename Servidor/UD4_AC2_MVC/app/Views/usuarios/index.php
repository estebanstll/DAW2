    ...
    <style>
        * {
        ...
        .login-container {
            ...
            padding: 50px 40px;
            border-radius: 20px;
            box-shadow: 0 0 40px rgba(255,107,53,0.3), inset 0 0 20px rgba(255,107,53,0.1);
            width: 100%;
            max-width: 450px;
...
<div class="login-container">
    <h1>🍕 FOODHUB</h1>
    <div class="subtitle">[ PORTAL DE ACCESO RESTAURANTE ]</div>
    <?php if(isset($error)): ?>
        <div class="error">❌ <?php echo htmlspecialchars($error); ?></div>
    <?php endif; ?>
    <form action="<?= BASE_URL ?>usuarios/isLogged" method="post">
        <div class="form-group">
            <label for="usuario">» EMAIL DE USUARIO</label>
