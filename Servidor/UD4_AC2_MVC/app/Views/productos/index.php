...
</head><span class="category-emoji">🍽️</span>
<body>
...
<div class="container">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?= $producto->getPeso() ?> kg</div>
                        </div>
                        <div class="info-item">
                    ...
                    <form class="product-form" action="" method="post"
                          onsubmit="this.action='<?= BASE_URL ?>productos/agregarCarrito/<?= $producto->getCodProd() ?>/' + this.unidades.value + '/<?= $producto->getCodCat() ?>'; return true;">
    ...
    <?php else: ?>
        <div class="no-products">
            <p>⚠️ NO HAY PRODUCTOS EN ESTA CATEGORÍA</p>
        </div>
    <?php endif; ?>
</div>
